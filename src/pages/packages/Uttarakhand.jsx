...
`;
  ...
  return (
    <>
      <Helmet>
        <title>
          Uttarakhand Tour Package - 6N/7D Rishikesh, Mussoorie, Haridwar | RK
          Travels Sahab
        </title>
        <meta
          name="description"
          content="Book our 6 Nights / 7 Days Uttarakhand Tour Package starting at ₹15499. Explore Rishikesh, Dehradun, Mussoorie, and Haridwar. Ganga Aarti, Kempty Falls, Ropeway & more!"
        />
        <meta
          name="keywords"
          content="Uttarakhand tour package, Rishikesh Mussoorie Haridwar trip, 7 days Uttarakhand itinerary, Ganga Aarti Haridwar, Gun Hill Mussoorie, RK Travels Sahab"
        />
        <meta
          property="og:title"
          content="Uttarakhand Tour Package - Rishikesh, Mussoorie & Haridwar | 6N/7D | RK Travels Sahab"
        />
        <meta
          property="og:description"
          content="Experience peace, hills, and adventure with our 6 Nights 7 Days Uttarakhand tour. Visit Rishikesh, Mussoorie, Dehradun, and Haridwar with all major sightseeing."
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:url"
          content="https://rktravelssahab.com/packages/uttarakhand"
        />
        ...
        <link
          rel="canonical"
          href="https://rktravelssahab.com/packages/uttarakhand"
        />
      </Helmet>
      ...
      <div className="w-full h-full font-[Boldonse] text-stone-800 bg-white">
        ...
        <div className="w-full p-10 px-6 lg:p-14 flex flex-col gap-8 lg:gap-12 lg:items-center lg:justify-center lg:text-center">
          ...
          <p className="text-lg font-[Poppins] text-stone-600 max-w-2xl">
            ...
            Uttarakhand Tour Package, covering Rishikesh, Dehradun, Mussoorie
            and Haridwar. A perfect blend of nature, peace, and adventure!
          </p>
          ...
          <div className="flex flex-col gap-6 lg:items-center lg:text-left lg:w-[70%]">
            ...
            <div className="text-lg font-[Poppins] text-stone-600 max-w-2xl">
              <p>
                ...
                <br />
                Pickup from Delhi and drive to Rishikesh. After hotel check-in
                and freshening up, explore Ram Jhula, Laxman Jhula, Munni Ki
                Reti, and witness the mesmerizing Evening Ganga Aarti. Dinner
                and overnight stay in Rishikesh.
              </p>
              <br />
              <p>
                ...
                and local markets. Reach Mussoorie by evening and check in.
                Dinner and night stay in Mussoorie.
              </p>
              <br />
              <p>
                ...
                <br />
                Full-day sightseeing in Mussoorie. Visit Mall Road, Kempty
                Falls, Library Chowk, and enjoy Gun Hill Ropeway (at your own
                cost). Dinner and overnight stay in Mussoorie.
              </p>
              <br />
              <p>
                ...
                <br />
                Post breakfast, check out and proceed to Haridwar. After
                check-in, explore Har Ki Pauri, Mansa Devi Temple (Ropeway on
                own cost), and attend the sacred evening Ganga Aarti. Dinner and
              ...
              <p>
                ...
                <br />
                After breakfast, check out and return to Delhi for your
                departure by flight or train. Trip ends with beautiful memories!
              </p>
            </div>
          </div>
