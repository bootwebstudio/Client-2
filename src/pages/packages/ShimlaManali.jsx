...
`;
  ...
  return (
    <>
      <Helmet>
        <title>
          Shimla Manali Tour Package - 7N/8D Hills & Adventure | RK Travels
          Sahab
        </title>
        <meta
          name="description"
          content="Explore the best of Shimla and Manali with our 7 Nights / 8 Days tour package. Includes Kufri, Solang Valley, Mall Road, Hadimba Temple, and more. Book now with RK Travels Sahab!"
        />
        <meta
          name="keywords"
          content="Shimla Manali tour package, 7 nights 8 days Himachal tour, Kufri sightseeing, Solang Valley trip, Rohtang Pass package, RK Travels Sahab"
        />
        <meta
          property="og:title"
          content="Shimla - Manali Tour Package | Scenic Hills | 7N/8D | RK Travels Sahab"
        />
        <meta
          property="og:description"
          content="Discover the beauty of Himachal with our Shimla-Manali package. Local sightseeing, Kufri excursion, Solang Valley adventures, and more — all planned for your comfort!"
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:url"
          content="https://rktravelssahab.com/packages/shimla-manali"
        />
        ...
        <link
          rel="canonical"
          href="https://rktravelssahab.com/packages/shimla-manali"
        />
      </Helmet>
          ...
          <div className="flex flex-col gap-6 lg:items-center lg:text-left lg:w-[70%]">
            ...
            <div className="text-lg font-[Poppins] text-stone-600 max-w-2xl">
              ...
              <p>
                ...
                Sankat Mochan Temple, and Jakhu Temple. In the afternoon, enjoy
                an excursion to Kufri and Chail. Overnight stay in Shimla.
              </p>
              <br />
              <p>
                ...
                Arrive at Manali and check-in to the hotel. Evening free to
                visit local markets. Overnight stay at Manali.
              </p>
              <br />
              <p>
                ...
                Temple, and Naggar Valley. Evening free for leisure at Mall
                Road. Overnight stay in Manali.
              </p>
              <br />
              <p>
              ...
              <p>
                ...
                <br />
                Check out from the hotel and drive back to Delhi or Chandigarh
                for departure.
              </p>
            </div>
          </div>
